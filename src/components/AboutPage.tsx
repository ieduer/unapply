      ...
      <section className="max-w-3xl mx-auto px-4 sm:px-6 pt-8 pb-24 flex flex-col gap-8 sm:gap-10 text-fog-300 leading-relaxed text-sm sm:text-base">
        ...
        <div>
          ...
          <ul className="flex flex-col gap-3 list-disc pl-5">
            ...
            <li><b className="text-fog-100">B 生活質量（24 題）</b>：宿舍、空調、澡堂、自習、晨跑、外賣、斷電、熱水、門禁等。眾包維度，缺失就缺失，不默認；單票樣本只展示、不排除。</li>
        ...
        <div>
          ...
          <ul className="flex flex-col gap-2 text-sm list-disc pl-5">
            ...
            <li><b className="text-fog-100">證據強度門檻</b>：眾包生活數據會記錄樣本量。只有 1 個人填答的值照常展示，但<span className="text-fog-100">不拿去做硬排除</span>——否則 1 票和 40 票一致擁有同樣的分量，結果會變成「被填答得越完整的學校越容易被劃掉」。官方章程與校方頁面的結論不受票數門檻限制，也不會被眾包覆蓋。</li>
